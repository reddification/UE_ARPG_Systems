#include "EQS/Tests/EnvQueryTest_Trace_Enhanced.h"

#include "EnvironmentQuery/Contexts/EnvQueryContext_Querier.h"
#include "EnvironmentQuery/Items/EnvQueryItemType_VectorBase.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(EnvQueryTest_Trace_Enhanced)
...
namespace EnvQueryTest_Trace_Helpers
{
	...
	template <bool bTraceToItem, EEnvTraceShape::Type Shape>
	void RunTraces(const UEnvQueryTest_Trace_Enhanced& Query, const TArrayView<FVector>& ContextLocations, FEnvQueryInstance& QueryInstance, float ContextZ, float ItemZ, const FEnvTraceData& TraceData, EEnvTestPurpose::Type TestPurpose, EEnvTestFilterType::Type FilterType, bool bWantsHit, const FCollisionQueryParams& TraceParams)
	{
...
UEnvQueryTest_Trace_Enhanced::UEnvQueryTest_Trace_Enhanced()
{
...
void UEnvQueryTest_Trace_Enhanced::RunTest(FEnvQueryInstance& QueryInstance) const
{
	...
	TraceParams.AddIgnoredActor(Cast<APawn>(QueryInstance.Owner.Get()));
...
void UEnvQueryTest_Trace_Enhanced::PostLoad()
{
	Super::PostLoad();
	TraceData.OnPostLoad();
}

FText UEnvQueryTest_Trace_Enhanced::GetDescriptionTitle() const
{
...
FText UEnvQueryTest_Trace_Enhanced::GetDescriptionDetails() const
{
