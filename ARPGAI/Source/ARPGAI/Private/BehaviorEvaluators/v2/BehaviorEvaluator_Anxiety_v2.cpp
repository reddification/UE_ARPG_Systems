...
void UBehaviorEvaluatorConfig_Anxiety_v2::GenerateFormulasDescriptions()
{
	...
	AlliesEvaluationParameters.IndividualUtilityOperationsContainer.GenerateFormulaDescription();
	AlliesEvaluationParameters.IndividualPriorityOperationsContainer.GenerateFormulaDescription();
	if (AlliesEvaluationParameters.RelevancyCondition.IsValid())
		AlliesEvaluationParameters.AutoGeneratedConditionsFormula = AlliesEvaluationParameters.RelevancyCondition.Get().ToString(0);
	else 
		AlliesEvaluationParameters.AutoGeneratedConditionsFormula = "";
}
